...
class TIPolicyDetailPlan : NSObject, NSCoding{

    var category : TIPolicyDetailCategory!
    ...
    var planType : String!
    var planTypeCategory : TIPolicyDetailPlanTypeCategory!
    ...
    @objc func parseJSONData(fromDictionary dictionary: NSDictionary)
    {
        if let categoryData = dictionary["category"] as? NSDictionary{
            category = TIPolicyDetailCategory(fromDictionary: categoryData)
        }
        else
        {
            category = TIPolicyDetailCategory(fromDictionary: NSDictionary.init())
        }
        ...
        if let planTypeCategoryData = dictionary["plan_type_category"] as? NSDictionary{
            planTypeCategory = TIPolicyDetailPlanTypeCategory(fromDictionary: planTypeCategoryData)
        }
        else
        {
            planTypeCategory = TIPolicyDetailPlanTypeCategory(fromDictionary: NSDictionary.init())
        }
    ...
    */
    ...
    {
         category = aDecoder.decodeObject(forKey: "category") as? TIPolicyDetailCategory
         ...
         planTypeCategory = aDecoder.decodeObject(forKey: "plan_type_category") as? TIPolicyDetailPlanTypeCategory
