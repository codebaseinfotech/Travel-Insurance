//
//    TIUserLoginResponse.swift
//
//    Create by Ankit Gabani on 19/9/2024
...
class TIUserLoginResponse : NSObject, NSCoding{
    ...
    @objc func parseJSONData(fromDictionary dictionary: NSDictionary)
    {
        ...
        cashOption = dictionary["cash_option"] as? String == nil ? "" : dictionary["cash_option"] as? String
        ...
        inboundEntitlement = dictionary["inbound_entitlement"] as? String == nil ? "" : dictionary["inbound_entitlement"] as? String
        ...
        permissionPurchase = dictionary["permission_purchase"] as? String == nil ? "" : dictionary["permission_purchase"] as? String
    ...
    func toDictionary() -> NSDictionary
    {
        ...
        if cashOption != nil{
            dictionary["cash_option"] = cashOption
        }
        if companyName != nil{
        ...
        if inboundEntitlement != nil{
            dictionary["inbound_entitlement"] = inboundEntitlement
        }
        ...
        if permissionPurchase != nil{
            dictionary["permission_purchase"] = permissionPurchase
        }
        if roleId != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
         ...
         cashOption = aDecoder.decodeObject(forKey: "cash_option") as? String
         ...
         inboundEntitlement = aDecoder.decodeObject(forKey: "inbound_entitlement") as? String
         ...
         permissionPurchase = aDecoder.decodeObject(forKey: "permission_purchase") as? String
    ...
    */
    public func encode(with aCoder: NSCoder)
    {
        ...
        if cashOption != nil{
            aCoder.encode(cashOption, forKey: "cash_option")
        }
        if companyName != nil{
        ...
        if inboundEntitlement != nil{
            aCoder.encode(inboundEntitlement, forKey: "inbound_entitlement")
        }
        if isOtpVerified != nil{
        ...
        if permissionPurchase != nil{
            aCoder.encode(permissionPurchase, forKey: "permission_purchase")
        }
        if roleId != nil{
