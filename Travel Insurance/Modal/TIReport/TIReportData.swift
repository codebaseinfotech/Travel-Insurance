...
class TIReportData : NSObject, NSCoding{

	var iQDAmount : String!
	var adminRejectReason : String!
	var agent : TIReportAgent!
	...
	var transectionStatus : [TIReportTransectionStatu]!
	var txnId : String!
	var updatedAt : String!
	var updatedBy : String!
	var usdAmount : String!
	var userId : Int!
	var userinsurance : [TIReportUserinsurance]!
	var userinsuranceCount : Int!
    var zone : String!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let agentData = dictionary["agent"] as? NSDictionary{
			agent = TIReportAgent(fromDictionary: agentData)
		}
		else
		{
			agent = TIReportAgent(fromDictionary: NSDictionary.init())
		}
		...
		if let plansData = dictionary["plans"] as? NSDictionary{
			plans = TIReportPlan(fromDictionary: plansData)
		}
		else
		{
			plans = TIReportPlan(fromDictionary: NSDictionary.init())
		}
		...
		userinsurance = [TIReportUserinsurance]()
		if let userinsuranceArray = dictionary["userinsurance"] as? [NSDictionary]{
			for dic in userinsuranceArray{
				let value = TIReportUserinsurance(fromDictionary: dic)
				userinsurance.append(value)
			}
		}
		userinsuranceCount = dictionary["userinsurance_count"] as? Int == nil ? 0 : dictionary["userinsurance_count"] as? Int
	...
	func toDictionary() -> NSDictionary
	{
		...
		if agent != nil{
			dictionary["agent"] = agent.toDictionary()
		}
		...
		if userinsuranceCount != nil{
			dictionary["userinsurance_count"] = userinsuranceCount
		}
		if zone != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         agent = aDecoder.decodeObject(forKey: "agent") as? TIReportAgent
         ...
         plans = aDecoder.decodeObject(forKey: "plans") as? TIReportPlan
         ...
         transectionStatus = aDecoder.decodeObject(forKey: "transection_status") as? [TIReportTransectionStatu]
         ...
         userinsurance = aDecoder.decodeObject(forKey: "userinsurance") as? [TIReportUserinsurance]
         userinsuranceCount = aDecoder.decodeObject(forKey: "userinsurance_count") as? Int
    ...
    */
    public func encode(with aCoder: NSCoder) 
	{
		...
		if userinsuranceCount != nil{
			aCoder.encode(userinsuranceCount, forKey: "userinsurance_count")
		}
		if zone != nil{
