...
class TIReportPlan : NSObject, NSCoding{

	var category : TIReportCategory!
	...
	var planType : String!
	var planTypeCategory : TIReportPlanTypeCategory!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		if let categoryData = dictionary["category"] as? NSDictionary{
			category = TIReportCategory(fromDictionary: categoryData)
		}
		else
		{
			category = TIReportCategory(fromDictionary: NSDictionary.init())
		}
		...
		if let planTypeCategoryData = dictionary["plan_type_category"] as? NSDictionary{
			planTypeCategory = TIReportPlanTypeCategory(fromDictionary: planTypeCategoryData)
		}
		else
		{
			planTypeCategory = TIReportPlanTypeCategory(fromDictionary: NSDictionary.init())
		}
    ...
    */
	...
	{
         category = aDecoder.decodeObject(forKey: "category") as? TIReportCategory
         ...
         planTypeCategory = aDecoder.decodeObject(forKey: "plan_type_category") as? TIReportPlanTypeCategory
