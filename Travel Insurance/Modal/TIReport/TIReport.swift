...
class TIReport : NSObject, NSCoding{

	var message : String!
	var response : TIReportResponse!
	var status : Int!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let responseData = dictionary["response"] as? NSDictionary{
			response = TIReportResponse(fromDictionary: responseData)
		}
		else
		{
			response = TIReportResponse(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         response = aDecoder.decodeObject(forKey: "response") as? TIReportResponse
