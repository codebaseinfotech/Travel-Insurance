//
//	TIModifyDetailPlan.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TIModifyDetailPlan : NSObject, NSCoding{

	var createdAt : String!
	var maxDays : Int!
	var planBenefits : [TIModifyDetailPlanBenefit]!
	var planFeatures : [String]!
	var planId : Int!
	var planImage : String!
	var planType : String!
	var planTypeCategory : TIModifyDetailPlanTypeCategory!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let planTypeCategoryData = dictionary["plan_type_category"] as? NSDictionary{
			planTypeCategory = TIModifyDetailPlanTypeCategory(fromDictionary: planTypeCategoryData)
		}
		else
		{
			planTypeCategory = TIModifyDetailPlanTypeCategory(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         planBenefits = aDecoder.decodeObject(forKey: "plan_benefits") as? [TIModifyDetailPlanBenefit]
         ...
         planTypeCategory = aDecoder.decodeObject(forKey: "plan_type_category") as? TIModifyDetailPlanTypeCategory
