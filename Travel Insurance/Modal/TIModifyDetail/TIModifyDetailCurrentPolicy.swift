//
//	TIModifyDetailCurrentPolicy.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TIModifyDetailCurrentPolicy : NSObject, NSCoding{
	...
	var fullName : String!
	var gender : String!
	var getTransection : TIModifyDetailGetTransection!
	var insuranceId : Int!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let getTransectionData = dictionary["get_transection"] as? NSDictionary{
			getTransection = TIModifyDetailGetTransection(fromDictionary: getTransectionData)
		}
		else
		{
			getTransection = TIModifyDetailGetTransection(fromDictionary: NSDictionary.init())
		}
		...
		if let plansData = dictionary["plans"] as? NSDictionary{
			plans = TIModifyDetailPlan(fromDictionary: plansData)
		}
		else
		{
			plans = TIModifyDetailPlan(fromDictionary: NSDictionary.init())
		}
		...
		if let userData = dictionary["user"] as? NSDictionary{
			user = TIModifyDetailUser(fromDictionary: userData)
		}
		else
		{
			user = TIModifyDetailUser(fromDictionary: NSDictionary.init())
		}
	...
	func toDictionary() -> NSDictionary
	{
		...
		if getTransection != nil{
			dictionary["get_transection"] = getTransection.toDictionary()
		}
		if insuranceId != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         getTransection = aDecoder.decodeObject(forKey: "get_transection") as? TIModifyDetailGetTransection
         ...
         plans = aDecoder.decodeObject(forKey: "plans") as? TIModifyDetailPlan
         ...
         user = aDecoder.decodeObject(forKey: "user") as? TIModifyDetailUser
    ...
    */
    public func encode(with aCoder: NSCoder) 
	{
		...
		if getTransection != nil{
			aCoder.encode(getTransection, forKey: "get_transection")
		}
		if insuranceId != nil{
