...
class TIplans : NSObject, NSCoding{

	var message : String!
	var response : [TIplansResponse]!
	var status : Int!
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         response = aDecoder.decodeObject(forKey: "response") as? [TIplansResponse]
