...
class TIplansResponse : NSObject, NSCoding{
	...
	var planType : String!
	var planTypeCategory : TIplansPlanTypeCategory!
	...
	@objc func parseJSONData(fromDictionary dictionary: NSDictionary)
	{
		...
		if let planTypeCategoryData = dictionary["plan_type_category"] as? NSDictionary{
			planTypeCategory = TIplansPlanTypeCategory(fromDictionary: planTypeCategoryData)
		}
		else
		{
			planTypeCategory = TIplansPlanTypeCategory(fromDictionary: NSDictionary.init())
		}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         planTypeCategory = aDecoder.decodeObject(forKey: "plan_type_category") as? TIplansPlanTypeCategory
