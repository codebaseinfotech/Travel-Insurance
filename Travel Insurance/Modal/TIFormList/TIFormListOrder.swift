...
class TIFormListOrder : NSObject, NSCoding{
    ...
    var userId : Int!
    var userinsurancedata : [TIFormListUserinsurancedata]!
    var zone : String!
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
         ...
         userinsurancedata = aDecoder.decodeObject(forKey: "userinsurancedata") as? [TIFormListUserinsurancedata]
