...
//  Friendz
//
//  Created by Ankit Gabani on 02/09/22.
//
...
extension UIViewController: Identifiable {
    /**
     Create an instance of the ViewController from its associated Storyboard and
     the Scene with identifier `sceneIdentifier`
