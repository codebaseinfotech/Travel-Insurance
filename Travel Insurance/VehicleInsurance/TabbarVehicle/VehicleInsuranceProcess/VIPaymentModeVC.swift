...
class VIPaymentModeVC: UIViewController {

    @IBOutlet weak var tblViewCardList: UITableView! {
        didSet {
            tblViewCardList.addObserver(self, forKeyPath: "contentSize", options: .new, context: nil)
    ...
    @IBOutlet weak var viewAddNoCard: UIView!
    
    override func viewDidLoad() {
        super.viewDidLoad()

        viewAddNoCard.isHidden = true
...
extension VIPaymentModeVC: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return 2
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tblViewCardList.dequeueReusableCell(withIdentifier: "VICardListTblViewCell") as! VICardListTblViewCell
...
//MARK: - VICardListTblViewCell
class VICardListTblViewCell: UITableViewCell {
    @IBOutlet weak var imgCarf: UIImageView!
